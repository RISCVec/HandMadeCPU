...
class Core extends Module {
    ...
    val mem_reg_mem_wen             = RegInit(0.U(MEM_LEN.W))
    ...
    // OP2_IMI: 2.U(3.W)
    // OP2_IMS: 3.U(3.W)
    val csignals = ListLookup(id_reg_inst, List(ALU_X, OP1_RS1, OP2_RS2, MEN_X, REN_X, WB_X, CSR_X),
        Array(
    ...
    exe_reg_imm_z_uext      := id_imm_u_uext
